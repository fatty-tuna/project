...
function place(){
	...
	for(var i:int = 0; i < maze.Length; i++){
		...
		if(maze[i].marked == true){
			...
			//Set active walls
			newRoom.GetComponent.<RoomBlock>().activatedWalls = [maze[i].sides[3],maze[i].sides[0],maze[i].sides[1],maze[i].sides[2],1,1];
